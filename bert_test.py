...
class BERTJobClassifier:
    def __init__(self,
                 model_dir: str ="bert_output/best_model",
                 label_map_file: str ="bert_output/label_mapping.json",
                 mongo_uri: str ="mongodb://localhost:27017",
                 db_name: str ="telegram",
                 collection_name: str="jobs",
                 text_field: str = "description",
                 prediction_field: str = "predicted_job_title_bert_model",
                 confidence_field: str = "prediction_confidence_bert_model",
                 max_length: int = 128,
                 batch_size: int = 1000):
    ...
    def predict_and_update_mongodb(self):
        ...
        texts = [f"{doc['title']} [SEP] {doc[self.text_field]}" for doc in docs]
